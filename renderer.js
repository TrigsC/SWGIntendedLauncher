...
const configFile = require('os').homedir() + '/Intended-Launcher.json';
var config = {folder: 'C:\\SWGIntended'};
...
websiteBtn.addEventListener('click', event => shell.openExternal("http://swgintended.com/"));
discordBtn.addEventListener('click', event => shell.openExternal("https://discord.gg/reKKJpq"));
